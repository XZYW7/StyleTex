...
OmegaConf.register_new_resolver(
    "texturedreamer", lambda a, b: os.path.basename(a)+ '_'+ os.path.splitext(os.path.basename(b))[0]
)
OmegaConf.register_new_resolver(
    "styletex", lambda a, b: os.path.splitext(os.path.basename(a))[0]+ '_'+ os.path.splitext(os.path.basename(b))[0]
)
# ======================================================= #
