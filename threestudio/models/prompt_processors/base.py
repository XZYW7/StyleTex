...
class PromptProcessorOutput:
    ...
    ref_text_embeddings: Float[Tensor, "N Nf"]
    ...
    def get_inverse_text_embeddings(self,
        ...
        return torch.cat([uncond_text_embeddings, null_text_embeddings ], dim=0)
...
class PromptProcessor(BaseObject):
    ...
    def configure(self) -> None:
        ...
        self.ref_prompt = self.cfg.ref_prompt


        threestudio.info(
            f"Using prompt [{self.prompt}] and negative prompt [{self.negative_prompt}], [{self.ref_prompt}]"
        )
    ...
    @staticmethod
    def spawn_func(pretrained_model_name_or_path, pretrained_model_cache_dir,prompts, cache_dir):
        raise NotImplementedError
            ...
            if self.cfg.spawn:
                ...
                subprocess = ctx.Process(
                    ...
                    args=(
                        ...
                        self.cfg.pretrained_model_cache_dir,
                        prompts_to_process,
                        self._cache_dir,
                    ),
                )
    ...
    def load_text_embeddings(self):
        ...
        self.ref_text_embeddings = self.load_from_cache(self.ref_prompt)[
            None, ...
        ]        
    ...
    def __call__(self) -> PromptProcessorOutput:
        return PromptProcessorOutput(
            ...
            ref_text_embeddings=self.ref_text_embeddings,
